...
/* package ExerciseSemigroup-0.1.0.0 */
#ifndef VERSION_ExerciseSemigroup
#define VERSION_ExerciseSemigroup "0.1.0.0"
#endif /* VERSION_ExerciseSemigroup */
#ifndef MIN_VERSION_ExerciseSemigroup
#define MIN_VERSION_ExerciseSemigroup(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ExerciseSemigroup */
...
#define CURRENT_PACKAGE_KEY "ExerciseSemigroup-0.1.0.0-DIuMnpMOh1KACBINRpfFx4"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "ExerciseSemigroup-0.1.0.0-DIuMnpMOh1KACBINRpfFx4"
